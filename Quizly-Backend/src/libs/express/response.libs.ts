...
class ExpressResponse {
  public static created(res: Response, msg: string): void {
    res.status(responseCodeEnum.created).json({ success: true, msg });
  }
  ...
  public static success(
    ...
    res.status(responseCodeEnum.success).json({ success: true, msg, data });
  }

  public static accepted(res: Response, msg: string): void {
    res.status(responseCodeEnum.accepted).json({success: true, msg });
  }
